package com.dong.video.exoPlayer;
...
/**
 * @packInfo:com.dong.video.exoPlayer
 * @author: yadong.qiu
 * Created by 邱亚东
 * Date: 2018/11/12
 * Time: 17:53
...
public class ExoMediaPlayer extends BaseInternalPlayer {
    ...
    private final SimpleExoPlayer mInternalPlayer;
    ...
    public static void init(Application application) {
        PlayerConfig.addDecoderPlan(new DecoderPlan(PLAN_ID,
                ExoMediaPlayer.class.getName(), "exoplayer"));
    ...
    private MediaSource getMediaSource(Uri uri) {
        ...
        switch (contentType) {
            case C.TYPE_DASH:
                ...
                return new DashMediaSource.Factory(factory, dataSourceFactory).createMediaSource(uri);
            case C.TYPE_SS:
                DefaultSsChunkSource.Factory ssFactory = new DefaultSsChunkSource.Factory(dataSourceFactory);
                return new SsMediaSource.Factory(ssFactory, dataSourceFactory).createMediaSource(uri);
            case C.TYPE_HLS:
            ...
            if (isBuffering) {
                switch (playbackState) {
                    ...
                    case Player.STATE_ENDED:
                        ...
                        PLog.d(TAG, "buffer-end,BandWidth:" + bitrateEstimate);
                        isBuffering = false;
                        Bundle bundle = BundlePool.obtain();
